  ...
  return (
    <>
      ...
      <div className="flex px-5">
        <div className="w-[50%]">
          <p className="font-bold text-xl my-4">Post Transplant Care</p>
          <div>
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/vGCKwdMYWDo?si=bneqUDeREeV6e2UU"
        ...
        <div>
            <h1 className="font-bold text-blue-500 mx-4 text-xl my-2">GUIDELINES</h1>
            <p className="text-sm px-5 py-4">
...
Ask friend to visit only when they are well.
...
If someone in the patient’s family becomes ill with a cold of flu, have that individual follow normal precautions (use masks, separate drinking glasses, covering their mouths when coughing, etc.)
Avoid working in the soil for 6 months after the transplant. Thereafter, wear gloves.
Avoid handling animal waste and avoid contact with animals who roam outside. Do not clean birdcages or fish or turtle tanks or cat litter. The cat litter box should be covered and taken out of a patient’s home before it is changed.
