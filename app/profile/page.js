...
const Profile=()=>{
    ...
    <p className="text-2xl font-extrabold">Welcome <span className="text-blue-600  ">{localStorage.getItem("name")?localStorage.getItem("name"):"User"} !!!</span></p>
    <div className="my-5 shadow-md w-[400px]">
        ...
        <p className="text-base font-medium my-1">Age: <span className="text-blue-600  ">{localStorage.getItem('age')?localStorage.getItem('age'):"21"}</span></p>
        <p className=" font-medium my-1">Gender: <span className="text-blue-600  ">{localStorage.getItem('gender')?localStorage.getItem('gender'):"Male"}</span></p>
        <p className=" font-medium my-1">Blood Group: <span className="text-blue-600  ">{localStorage.getItem('blood_group')?localStorage.getItem('blood_group'):"A+"}</span></p>
