...
import BotPlay from "../../public/bot/botIcons/BotPause";
    ...
    <div className="flex flex-col space-y-3 px-3">
      ...
      <div className="flex w-full">
        <div className="flex flex-col flex-1">
          <div className="rounded-l-md rounded-b-md text-left text-xs text-black break-all py-2 px-2 bg-red-100 mr-3">
            {props.prompt.text}
          </div>
      ...
      <div className="flex w-full ">
        <div className="mr-3">
          <img
            ...
            src={"/bot/botIcons/BotProfileImg.svg"}
            alt=""
          />
        </div>
        ...
        {!props.isLoading && <div className="flex flex-col flex-1">
          <div className={ "rounded-l-md rounded-b-md text-left text-xs text-black py-1 text-blackShade-050 break-all  px-3 bg-red-100 mr-3 whitespace-pre-line" }>
            {props.res.text}
          </div>
          <p className="flex items-end justify-end text-[10px] text-black mr-3 mt-0.5">
            {props.res.time}
